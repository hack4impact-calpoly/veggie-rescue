...
const EntityForm = (props: any) => {
  ...
  const [locationType, setLocationType] = useState(
    props.isUpdate ? (props.whichEntity ? props.donor.LocationType : '') : ''
  );
  ...
  let orgStruc = ['Church', 'Shelter', 'School', 'Senior Center', 'Food Pantry - Other', 'Temp Food Pantry - Other', 'Nonprofit']
      ...
      <div className="entity-card" id="modal">
        ...
        <div className="entity-type">
          <button
            ...
            type="button"
            onClick={handleDonor}
            style={{ border: isDonor ? '2px solid #FF9C55' : '' }}
          >
            Donor
          </button>
          <button
        ...
        <input
          className="input"
          placeholder={!props.isUpdate ? 'Entity Type' : ''}
          defaultValue={
            props.isUpdate
              ? isDonor
                ? props.donor.EntityType
          ...
          {foodTypes.map((v: any, index: any) => {
            return (
              <Button
                ...
                id={index}
                name={v}
                handleClick={handleFoodClick.bind(this, v)}
              />
            );
          })}
        </div>
        ...
        {isDonor ? (
          <div className="internal-div">
            ...
            <input
              ...
              placeholder={!props.isUpdate ? 'Location Type' : ''}
              defaultValue={props.isUpdate ? props.donor.LocationType : ''}
          ...
          <div className="internal-div">
            ...
            <input
              ...
              placeholder={!props.isUpdate ? 'Demographic Name' : ''}
              defaultValue={
                props.isUpdate ? props.recipient.DemographicName : ''
              }
        ...
        <input
          ...
          placeholder={!props.isUpdate ? 'Combined Area Name' : ''}
          defaultValue={
            props.isUpdate
              ? isDonor
                ? props.donor.CombinedAreaName
