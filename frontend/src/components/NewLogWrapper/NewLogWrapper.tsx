  ...
  useEffect(() => {
    ...
    if(doneFlag && !vehicleIsLoading) {
        ...
        const newPickup : Pickup = {
            ...
            donorEntityType : pickupDeliveryObject.recipientEntityType,
            foodType: pickupDeliveryObject.foodType[0],
        ...
        const newDropoff : Dropoff = {          
            ...
            vehicle: vehicle.name,
            name: pickupDeliveryObject.name,
            recipientEntityType : pickupDeliveryObject.recipientEntityType,
