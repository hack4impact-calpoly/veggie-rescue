...
import { clear as clearDonors } from '../../features/donors/donorSlice';
import { clear as clearRecipients } from '../../features/recipients/recipientsSlice';
...
function Dashboard() {
  ...
  const { isSuccess: batchDropoffSuccess, isError: isDropoffError } =
    useAppSelector((state) => state.dropoffs);
  ...
  return (
    <div className="container bgimg dashboard">
      ...
      <div className="action">
        <button type="submit" onClick={() => handleClick(0)}>
          <div className="action-item">
            <FaPencilAlt className="text-amber-600" />
            <div>Start a Log</div>
          </div>
        </button>
        <button type="submit" onClick={() => handleClick(1)}>
          <div className="action-item">
        ...
        <div id="bottom-button">
          <button type="submit" onClick={() => handleClick(2)}>
            <div className="action-item">
